...
<template>
  <div class="h-fit">
    <div class="max-w-5xl mx-auto px-8 py-8">
      ...
      <!-- Team -->
      <section class="bg-white rounded-2xl p-8 md:p-12 shadow-sm mb-12">
      ...
      <!-- Contact CTA -->
      <section class="w-full bg-gradient-to-r from-primary to-secondary rounded-2xl p-8 md:p-12 text-center text-white mb-0">
