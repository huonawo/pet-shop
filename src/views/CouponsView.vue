...
<template>
  <div class="min-h-screen">
    <div class="w-full px-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-12 py-8 mr-4">
      <div class="mb-8">
        <div class="flex items-center justify-between w-full mb-2">
          ...
          <button
            ...
            class="shrink-0 px-8 py-3 bg-gradient-to-r from-accent to-primary text-white font-semibold rounded-full hover:shadow-lg transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <p class="text-text-muted mt-3">领取优惠券，享受更多优惠</p>
      </div>
      ...
      <template v-else>
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 lg:gap-6 mb-8">
          <button
            class="px-5 py-3.5 rounded-full text-base font-medium transition-all duration-200"
        ...
        <div v-if="activeTab === 'claimable'">
          ...
          <div v-else class="space-y-4">
            <div
              ...
              :key="coupon.id"
              class="bg-gradient-to-r from-accent/5 to-primary/5 rounded-2xl overflow-hidden border-2 border-dashed border-accent/30 hover:border-accent transition-all"
            >
              <div class="flex flex-col sm:flex-row">
                <div class="w-full sm:w-28 bg-gradient-to-b from-accent to-accent-dark text-white p-4 flex flex-col items-center justify-center">
                  <span class="text-2xl font-bold">
                    {{ coupon.type === 'minus' ? `¥${coupon.value}` : `${coupon.value}折` }}
                  </span>
                  <span class="text-xs opacity-90 mt-1">{{ coupon.desc }}</span>
                </div>
        ...
        <div v-if="activeTab === 'available'">
          ...
          <div v-else class="space-y-4">
            <div
              ...
              :key="coupon.id"
              class="bg-card-bg rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all"
        ...
        <div v-if="activeTab === 'used'" class="space-y-4">
          ...
          <div
            ...
            :key="coupon.id"
            class="bg-card-bg rounded-2xl p-4 sm:p-6 shadow-sm opacity-60"
          >
            <div class="flex flex-col sm:flex-row items-start justify-between gap-4">
              <div class="flex-1">
                <h3 class="font-semibold text-text-dark">{{ coupon.name }}</h3>
        ...
        <div v-if="activeTab === 'expired'" class="space-y-4">
